...
class Config {
   public:
    ...
    int shift_bits;
    int ch_pos, ra_pos, bg_pos, ba_pos, ro_pos, co_pos, CO_pos;
    uint64_t ch_mask, ra_mask, bg_mask, ba_mask, ro_mask, co_mask, CO_mask;
    ...
    std::string scheduling_policy; //expects FCFS or FRFCFS
